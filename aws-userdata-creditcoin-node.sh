...
# 
# Notables 
# 1. Uses Podman rather than Docker - initial version runs as system - subsequent will run
#    in systemd user context as I have tested that approach with no issues.  Using root was the only
#    way to limit CPU under a certain discount cloud vps provider... 
...
# 3. Creates a custom SELinux module to accomodate the specific container requirements.  
#    Udica is your friend. Don't disable SELinux.
# 4. Data is stored locally at /app/ctcmn
# 4. I like bash-completion. 'nuff said.
